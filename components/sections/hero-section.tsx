	...
	return (
		...
		>
			<LampContainer className="h-screen">
				...
				>
					Hello, I am <br />{" "}
					<AuroraText speed={2}>Abiral    Jain</AuroraText> 👋
				</motion.h1>
				<motion.div
				...
				>
					<Link href="mailto:abiral2724@gmail.com">
						<Button size="xl" className="!z-20">
							Get In Touch
						</Button>
					</Link>
					<Link
						href="https://drive.google.com/file/d/1OYYM6MmWd_SzLLIogpc_t5DcBZTgukNx/view?usp=sharing"
						download="[Resume] Abiral Jain.pdf"
					>
